...
Селектор `.cat-head` повинен мати властивість `top` зі значенням будь-якого числа в `px`. Make sure you add a semi-colon.
...
Селектор `.cat-head` повинен мати властивість `left` зі значенням будь-якого числа в `px`. Make sure you add a semi-colon.
